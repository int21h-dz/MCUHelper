...
[`VS Code ^1.85`](https://code.visualstudio.com/download) · `Node.js` · язык `mcunr` · 370+ тестов
...
**McuHelper** добавляет в VS Code удобную работу с ними: подсветку, диагностику, подсказки и навигацию.
...
Иконка в Activity Bar открывает контейнер **MCU-NR** с девятью вкладками:
