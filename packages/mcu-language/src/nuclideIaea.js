...
exports.mcuNuclideToIaeaTarget = mcuNuclideToIaeaTarget;
exports.mcuNuclideToIaeaElement = mcuNuclideToIaeaElement;
 ...
 */
function mcuNuclideToIaeaTarget(name) {
...
function mcuNuclideToIaeaElement(name) {
    const raw = name.trim().toUpperCase();
    if (!/^[A-Z]{1,2}$/.test(raw))
        return null;
    return formatElement(raw);
}
//# sourceMappingURL=nuclideIaea.js.map