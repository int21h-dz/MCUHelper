...
export const EXTRA_CARD_DESCRIPTIONS: ExtraCard[] = [
  // --- PIN ---
  {
    ...
    syntax: "SI list",
    description:
      "Список нуклидов, входящих в суммарный изотоп (UserGuide §8.5). Действует с момента объявления; без list — суммарный изотоп пуст. При одновременном SI и SINOT перед материалом активен последний объявленный список. Печать сечений суммарного изотопа — карта SIPRN.",
