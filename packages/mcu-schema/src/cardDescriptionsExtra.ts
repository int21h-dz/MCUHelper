...
export const EXTRA_CARD_DESCRIPTIONS: ExtraCard[] = [
  // --- PIN ---
  {
    ...
    syntax: "SI list",
    description:
      "Номера/имена нуклидов, для которых на печать выводятся сечения. Используется совместно с SINOT; при наличии обоих списков печать по объединению.",
    fragment: "physical",
  },
  {
    label: "SINOT",
  ...
  },
  {
    ...
    syntax: "SIDEN value",
    description:
      "Пороговое значение: сечения с вкладом ниже порога не печатаются. Активна независимо от SI/SINOT.",
    fragment: "physical",
  },
  {
    label: "CPM",
    ...
    syntax: "CPM n",
    description:
      "Начало блока материалов, номера которых будут размножены с шагом n (повышение номера MATR). Закрывается CPMEND.",
    fragment: "physical",
  },
  {
    label: "CPMEND",
  ...
  },
  {
    ...
    syntax: "C= SHOW",
    description:
      "В таблицу поступают последние значения параметров (вместо накопленных). Задаётся в колонках 1–2 как комментарий C=.",
    fragment: "physical",
  },
  {
    label: "ICE",
    ...
    syntax: "ICE list",
    description:
      "Список химических элементов (имена), для которых выполняется автоматическое разложение на изотопы по данным библиотеки.",
    fragment: "physical",
  },
  {
    label: "ICENOT",
  ...
  },
  {
    ...
    description:
      "Ненормированные веса 26 энергетических интервалов SPNT (пары с ESET). По умолчанию — спектр деления 235U.",
    fragment: "source",
  },
  {
    label: "MMES",
  ...
  },
  {
    ...
    description:
      "Именованный элемент источника и тип частицы (N, PH, EL, PO). Используется с ROOT, BOUN, NORM.",
    fragment: "source",
  },
  {
    label: "NORM",
