...
exports.EXTRA_CARD_DESCRIPTIONS = void 0;
/** Ручные описания карт, которые плохо извлекаются из TXT (§10–15 UserGuide). */
exports.EXTRA_CARD_DESCRIPTIONS = [
    // --- PIN ---
    {
        label: "SI",
        title: "Список нуклидов для печати сечений",
        syntax: "SI list",
        description: "Номера/имена нуклидов, для которых на печать выводятся сечения. Используется совместно с SINOT; при наличии обоих списков печать по объединению.",
        fragment: "physical",
    },
    {
        label: "SINOT",
    ...
    },
    {
        ...
        syntax: "SIDEN value",
        description: "Пороговое значение: сечения с вкладом ниже порога не печатаются. Активна независимо от SI/SINOT.",
        fragment: "physical",
    },
    {
        label: "CPM",
        ...
        syntax: "CPM n",
        description: "Начало блока материалов, номера которых будут размножены с шагом n (повышение номера MATR). Закрывается CPMEND.",
        fragment: "physical",
    },
    {
        label: "CPMEND",
    ...
    },
    {
        ...
        syntax: "C= SHOW",
        description: "В таблицу поступают последние значения параметров (вместо накопленных). Задаётся в колонках 1–2 как комментарий C=.",
        fragment: "physical",
    },
    {
        label: "ICE",
        ...
        syntax: "ICE list",
        description: "Список химических элементов (имена), для которых выполняется автоматическое разложение на изотопы по данным библиотеки.",
        fragment: "physical",
    },
    {
        label: "ICENOT",
    ...
    // --- Источники (SPNT / сложный) ---
    {
        ...
        syntax: "ENSO E",
        description: "Энергия (эВ) дельта-спектра простого точечного источника SPNT. Несовместима с ESET и SPEC.",
        fragment: "source",
    },
    {
        label: "ESET",
        ...
        description: "27 границ энергетических интервалов (эВ, по убыванию) для SPNT; частицы рождаются в серединах интервалов. Альтернатива SPEC/ENSO.",
        fragment: "source",
    },
    {
        label: "SPEC",
        ...
        description: "Ненормированные веса 26 энергетических интервалов SPNT (пары с ESET). По умолчанию — спектр деления 235U.",
        fragment: "source",
    },
    {
        label: "MMES",
    ...
    },
    {
        ...
        description: "Именованный элемент источника и тип частицы (N, PH, EL, PO). Используется с ROOT, BOUN, NORM.",
        fragment: "source",
    },
    {
        label: "NORM",
    ...
    },
    {
        ...
        description: "Прямоугольные границы в локальных координатах элемента (пары mi,ni и mj,nj) для распределения рождения.",
        fragment: "source",
    },
    {
        label: "PRISOU",
    ...
    // --- Геометрия NET ---
    {
        ...
        syntax: "V01 v1 v2 …",
        description: "Строка картограммы сети NET: типы ячеек по вершинам (V — vertex). Аналог T01/P01/O01/G01.",
        fragment: "geometry",
    },
    // --- Регистрация ---
    {
    ...
    // --- Траектории / CALD неаналог ---
    {
        ...
        syntax: "WTOB w1 w2 …",
        description: "Множители веса wi для вторичных частиц, рождённых в регистрационном объекте i; wi=0 — частицы не моделируются.",
        fragment: "trajectory",
    },
    {
        label: "WWEN",
        ...
        syntax: "WWEN E1 E2 …",
        description: "Упорядоченные по возрастанию границы отрезков по энергии (эВ) для неаналогового моделирования; левая граница первого — 0.",
    ...
    },
    {
        ...
        description: "Центр сферической (3 числа) или ось цилиндрической (2 числа) системы для весового окна по геометрии.",
        fragment: "calculationControl",
    },
    {
        label: "RADS",
    ...
    },
    {
        ...
        description: "К какому типу частиц относятся следующие карты неаналогового моделирования (N/PH/EL/PO). По умолчанию N.",
        fragment: "calculationControl",
    },
    {
        label: "SERIES",
    ...
    // --- Выгорание: CODE-опции и вспомогательные ---
    {
        ...
        syntax: "FINAL + TIMP …",
        description: "Интерполяция концентраций и сечений в дополнительных временных точках; результат в VAR.FNL. Многократные вызовы.",
        fragment: "burnup",
    },
    {
        label: "DELAY",
        ...
        description: "Расчёт эволюции изотопов после остановки реактора. Вход: VAR.FNL; результат VAR.DLT.",
        fragment: "burnup",
    },
    {
        label: "FINTAB",
        ...
        description: "Постобработка и печать интегральных характеристик, концентраций и сечений после STEP/FINAL.",
        fragment: "burnup",
    },
    {
        label: "DELTAB",
    ...
    },
    {
        ...
        description: "Задание потока нейтронов как функции времени (альтернатива POWE/DPOW для нормировки выгорания).",
        fragment: "burnup",
    },
    {
        label: "DPOW",
    ...
    },
    {
        ...
        description: "Ступени STEP: t — длина интервала (сут), n — число шагов на интервале. Взаимоисключающа с STEP.",
        fragment: "burnup",
    },
    {
        label: "COLI",
        ...
        description: "Кусочно-линейная (0) или постоянная (1) интерполяция мощности и сечений между узлами STEP.",
        fragment: "burnup",
    },
    {
        label: "SIZI",
...
//# sourceMappingURL=cardDescriptionsExtra.js.map