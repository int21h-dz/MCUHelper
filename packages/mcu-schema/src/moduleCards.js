...
exports.PHYSICAL_EXTRA_CARDS = exports.REGISTRATION_EXTRA_CARDS = exports.SOURCE_CARDS = void 0;
/** Карты модуля источников (UserGuide §10.2). */
exports.SOURCE_CARDS = [
    {
        label: "NPS",
    ...
    },
    {
        ...
        description: "Имя спектра (≤4 символа) и зависимость E/μ: NO, MTOE, ETOM, FUNC; L — линейный переход.",
        fragment: "source",
    ...
    },
    {
        ...
        description: "Контейнер с внутренним распределением вероятности рождения; доп. HGRI/HPC, RGRI/RPC.",
        fragment: "source",
...
exports.REGISTRATION_EXTRA_CARDS = [
    {
        label: "ZELEN",
...
//# sourceMappingURL=moduleCards.js.map